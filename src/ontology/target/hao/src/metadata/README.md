 ...
 * [hao.yml](hao.yml)
     * Determines how your purl.obolibrary.org/obo/hao/ redirects will be handled
     ...
     * Paste in the contents of [hao.yml](hao.yml)
 ...
 * [hao.md](hao.md)
     ...
     * Paste in the contents of [hao.md](hao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
